...
public class Update_doc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(dept, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 290, 200, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 370, 150, 40));
        ...
        jLabel2.setText("EDIT DOCTOR");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 20, -1, 50));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 290, 90, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Vaibhavi\\Pictures\\new.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try
       {
            ...
            //String sql="UPDATE  add_doctor SET  First Name = ?, Middle Name =?, Last Name = ?, Age= ?, Contact = ?,  Department = ?,Address = ?  WHERE  Doctor ID = ?";

            PreparedStatement ptst = con.prepareStatement("UPDATE  add_doctor  SET  `First Name` = ?, `Middle Name` =?, `Last Name` = ?, Age= ?, Contact = ?,Department = ?,Address = ?  WHERE  `Doctor ID` = ?");
            ...
            ptst.setString (2, M_name.getText());
             ...
             ptst.setString (8,doc_id.getText( ) );  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_doc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_doc().setVisible(true);
            }
        });
    }
